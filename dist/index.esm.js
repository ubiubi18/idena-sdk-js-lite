...
function sender(data, signature, withPrefix = true) {
    ...
    const pubKey = secp256k1.Signature.fromBytes(new Uint8Array(signature).slice(0, -1))
...
function sign(data, key) {
    const hash = sha3.keccak_256.array(data);
    const signature = secp256k1.sign(new Uint8Array(hash), typeof key === 'string' ? hexToUint8Array(key) : new Uint8Array(key));
