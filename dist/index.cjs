...
class StoreToIpfsAttachment {
    ...
    fromBytes(bytes) {
        const protoAttachment = protobuf.fromBinary(ProtoStoreToIpfsAttachmentSchema, bytes);
        this._cid = protoAttachment.cid;
        this._size = protoAttachment.size;
        return this;
    }
    toBytes() {
        const attachment = protobuf.create(ProtoStoreToIpfsAttachmentSchema, {
            cid: this._cid,
            size: this._size,
        });
        return protobuf.toBinary(ProtoStoreToIpfsAttachmentSchema, attachment);
    }
}
...
class CallContractAttachment {
    ...
    fromBytes(bytes) {
        const protoAttachment = protobuf.fromBinary(ProtoCallContractAttachmentSchema, bytes);
        this._method = protoAttachment.method;
        this._args = protoAttachment.args;
        return this;
    }
    toBytes() {
        const attachment = protobuf.create(ProtoCallContractAttachmentSchema, {
            method: this._method,
            args: this._args.map((x) => x || new Uint8Array()),
        });
        return protobuf.toBinary(ProtoCallContractAttachmentSchema, attachment);
    }
}
...
function privateKeyToPublicKey(key, withPrefix = false) {
    const pubKey = secp256k1__namespace.getPublicKey(getKeyArray(key), false);
...
class Transaction {
    ...
    get sender() {
        try {
            if (!this._signature || this._signature.length === 0)
                return null;
            const data = protobuf.toBinary(ProtoTransaction_DataSchema, this._createProtoTxData());
    ...
    fromBytes(bytes) {
        const protoTx = protobuf.fromBinary(ProtoTransactionSchema, bytes);
    ...
    toBytes() {
        const tx = protobuf.create(ProtoTransactionSchema, {
            data: this._createProtoTxData(),
            signature: this._signature ?? new Uint8Array(),
        });
        return protobuf.toBinary(ProtoTransactionSchema, tx);
    }
    sign(key) {
        const data = protobuf.toBinary(ProtoTransaction_DataSchema, this._createProtoTxData());
    ...
    _createProtoTxData() {
        return protobuf.create(ProtoTransaction_DataSchema, {
            epoch: this._epoch,
            nonce: this._nonce,
            type: this._type,
...
exports.ProtoAdBurnKeySchema = ProtoAdBurnKeySchema;
exports.ProtoAdSchema = ProtoAdSchema;
exports.ProtoAdTargetSchema = ProtoAdTargetSchema;
exports.ProtoAdVotingParamsSchema = ProtoAdVotingParamsSchema;
exports.ProtoBurnAttachmentSchema = ProtoBurnAttachmentSchema;
exports.ProtoCallContractAttachmentSchema = ProtoCallContractAttachmentSchema;
exports.ProtoChangeProfileAttachmentSchema = ProtoChangeProfileAttachmentSchema;
exports.ProtoDeleteFlipAttachmentSchema = ProtoDeleteFlipAttachmentSchema;
exports.ProtoDeployContractAttachmentSchema = ProtoDeployContractAttachmentSchema;
exports.ProtoFlipKeySchema = ProtoFlipKeySchema;
exports.ProtoFlipKey_DataSchema = ProtoFlipKey_DataSchema;
exports.ProtoFlipPrivateKeysSchema = ProtoFlipPrivateKeysSchema;
exports.ProtoFlipSubmitAttachmentSchema = ProtoFlipSubmitAttachmentSchema;
exports.ProtoIpfsFlipSchema = ProtoIpfsFlipSchema;
exports.ProtoLongAnswerAttachmentSchema = ProtoLongAnswerAttachmentSchema;
exports.ProtoOnlineStatusAttachmentSchema = ProtoOnlineStatusAttachmentSchema;
exports.ProtoPrivateFlipKeysPackageSchema = ProtoPrivateFlipKeysPackageSchema;
exports.ProtoPrivateFlipKeysPackage_DataSchema = ProtoPrivateFlipKeysPackage_DataSchema;
exports.ProtoProfileSchema = ProtoProfileSchema;
exports.ProtoProfile_ProtoProfileAdSchema = ProtoProfile_ProtoProfileAdSchema;
exports.ProtoShortAnswerAttachmentSchema = ProtoShortAnswerAttachmentSchema;
exports.ProtoStoreToIpfsAttachmentSchema = ProtoStoreToIpfsAttachmentSchema;
exports.ProtoTerminateContractAttachmentSchema = ProtoTerminateContractAttachmentSchema;
exports.ProtoTransactionSchema = ProtoTransactionSchema;
exports.ProtoTransaction_DataSchema = ProtoTransaction_DataSchema;
exports.StoreToIpfsAttachment = StoreToIpfsAttachment;
...
exports.contractArgumentFormat = contractArgumentFormat;
exports.dnaToFloatString = dnaToFloatString;
exports.embeddedContractType = embeddedContractType;
exports.file_models = file_models;
